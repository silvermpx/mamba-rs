...
SM120_DEFINE_KERNEL(nn_sm120_tma_64x64_bk32_s2_bf16, __nv_bfloat16, Sm120Nn, 64, 64, 32, 2)
SM120_DEFINE_KERNEL(nn_sm120_tma_64x64_bk32_s2_f16, __half, Sm120Nn, 64, 64, 32, 2)
SM120_DEFINE_KERNEL(nn_sm120_tma_64x64_bk32_s3_bf16, __nv_bfloat16, Sm120Nn, 64, 64, 32, 3)
SM120_DEFINE_KERNEL(nn_sm120_tma_64x64_bk32_s3_f16, __half, Sm120Nn, 64, 64, 32, 3)
SM120_DEFINE_KERNEL(nn_sm120_tma_64x64_bk64_s2_bf16, __nv_bfloat16, Sm120Nn, 64, 64, 64, 2)
SM120_DEFINE_KERNEL(nn_sm120_tma_64x64_bk64_s2_f16, __half, Sm120Nn, 64, 64, 64, 2)
SM120_DEFINE_KERNEL(nn_sm120_tma_64x64_bk64_s3_bf16, __nv_bfloat16, Sm120Nn, 64, 64, 64, 3)
SM120_DEFINE_KERNEL(nn_sm120_tma_64x64_bk64_s3_f16, __half, Sm120Nn, 64, 64, 64, 3)
SM120_DEFINE_KERNEL(nn_sm120_tma_128x64_bk32_s2_bf16, __nv_bfloat16, Sm120Nn, 128, 64, 32, 2)
SM120_DEFINE_KERNEL(nn_sm120_tma_128x64_bk32_s2_f16, __half, Sm120Nn, 128, 64, 32, 2)
SM120_DEFINE_KERNEL(nn_sm120_tma_128x64_bk32_s3_bf16, __nv_bfloat16, Sm120Nn, 128, 64, 32, 3)
SM120_DEFINE_KERNEL(nn_sm120_tma_128x64_bk32_s3_f16, __half, Sm120Nn, 128, 64, 32, 3)
SM120_DEFINE_KERNEL(nn_sm120_tma_128x64_bk64_s2_bf16, __nv_bfloat16, Sm120Nn, 128, 64, 64, 2)
SM120_DEFINE_KERNEL(nn_sm120_tma_128x64_bk64_s2_f16, __half, Sm120Nn, 128, 64, 64, 2)
SM120_DEFINE_KERNEL(nn_sm120_tma_128x64_bk64_s3_bf16, __nv_bfloat16, Sm120Nn, 128, 64, 64, 3)
SM120_DEFINE_KERNEL(nn_sm120_tma_128x64_bk64_s3_f16, __half, Sm120Nn, 128, 64, 64, 3)
SM120_DEFINE_KERNEL(nn_sm120_tma_64x128_bk32_s2_bf16, __nv_bfloat16, Sm120Nn, 64, 128, 32, 2)
SM120_DEFINE_KERNEL(nn_sm120_tma_64x128_bk32_s2_f16, __half, Sm120Nn, 64, 128, 32, 2)
SM120_DEFINE_KERNEL(nn_sm120_tma_64x128_bk32_s3_bf16, __nv_bfloat16, Sm120Nn, 64, 128, 32, 3)
SM120_DEFINE_KERNEL(nn_sm120_tma_64x128_bk32_s3_f16, __half, Sm120Nn, 64, 128, 32, 3)
SM120_DEFINE_KERNEL(nn_sm120_tma_64x128_bk64_s2_bf16, __nv_bfloat16, Sm120Nn, 64, 128, 64, 2)
SM120_DEFINE_KERNEL(nn_sm120_tma_64x128_bk64_s2_f16, __half, Sm120Nn, 64, 128, 64, 2)
SM120_DEFINE_KERNEL(nn_sm120_tma_64x128_bk64_s3_bf16, __nv_bfloat16, Sm120Nn, 64, 128, 64, 3)
SM120_DEFINE_KERNEL(nn_sm120_tma_64x128_bk64_s3_f16, __half, Sm120Nn, 64, 128, 64, 3)
SM120_DEFINE_KERNEL(nn_sm120_tma_128x128_bk32_s2_bf16, __nv_bfloat16, Sm120Nn, 128, 128, 32, 2)
SM120_DEFINE_KERNEL(nn_sm120_tma_128x128_bk32_s2_f16, __half, Sm120Nn, 128, 128, 32, 2)
SM120_DEFINE_KERNEL(nn_sm120_tma_128x128_bk32_s3_bf16, __nv_bfloat16, Sm120Nn, 128, 128, 32, 3)
SM120_DEFINE_KERNEL(nn_sm120_tma_128x128_bk32_s3_f16, __half, Sm120Nn, 128, 128, 32, 3)
SM120_DEFINE_KERNEL(nn_sm120_tma_128x128_bk64_s2_bf16, __nv_bfloat16, Sm120Nn, 128, 128, 64, 2)
SM120_DEFINE_KERNEL(nn_sm120_tma_128x128_bk64_s2_f16, __half, Sm120Nn, 128, 128, 64, 2)
SM120_DEFINE_KERNEL(nn_sm120_tma_128x128_bk64_s3_bf16, __nv_bfloat16, Sm120Nn, 128, 128, 64, 3)
SM120_DEFINE_KERNEL(nn_sm120_tma_128x128_bk64_s3_f16, __half, Sm120Nn, 128, 128, 64, 3)

SM120_DEFINE_KERNEL(tn_sm120_tma_64x64_bk32_s2_bf16, __nv_bfloat16, Sm120Tn, 64, 64, 32, 2)
SM120_DEFINE_KERNEL(tn_sm120_tma_64x64_bk32_s2_f16, __half, Sm120Tn, 64, 64, 32, 2)
SM120_DEFINE_KERNEL(tn_sm120_tma_64x64_bk32_s3_bf16, __nv_bfloat16, Sm120Tn, 64, 64, 32, 3)
SM120_DEFINE_KERNEL(tn_sm120_tma_64x64_bk32_s3_f16, __half, Sm120Tn, 64, 64, 32, 3)
SM120_DEFINE_KERNEL(tn_sm120_tma_64x64_bk64_s2_bf16, __nv_bfloat16, Sm120Tn, 64, 64, 64, 2)
SM120_DEFINE_KERNEL(tn_sm120_tma_64x64_bk64_s2_f16, __half, Sm120Tn, 64, 64, 64, 2)
SM120_DEFINE_KERNEL(tn_sm120_tma_64x64_bk64_s3_bf16, __nv_bfloat16, Sm120Tn, 64, 64, 64, 3)
SM120_DEFINE_KERNEL(tn_sm120_tma_64x64_bk64_s3_f16, __half, Sm120Tn, 64, 64, 64, 3)
SM120_DEFINE_KERNEL(tn_sm120_tma_128x64_bk32_s2_bf16, __nv_bfloat16, Sm120Tn, 128, 64, 32, 2)
SM120_DEFINE_KERNEL(tn_sm120_tma_128x64_bk32_s2_f16, __half, Sm120Tn, 128, 64, 32, 2)
SM120_DEFINE_KERNEL(tn_sm120_tma_128x64_bk32_s3_bf16, __nv_bfloat16, Sm120Tn, 128, 64, 32, 3)
SM120_DEFINE_KERNEL(tn_sm120_tma_128x64_bk32_s3_f16, __half, Sm120Tn, 128, 64, 32, 3)
SM120_DEFINE_KERNEL(tn_sm120_tma_128x64_bk64_s2_bf16, __nv_bfloat16, Sm120Tn, 128, 64, 64, 2)
SM120_DEFINE_KERNEL(tn_sm120_tma_128x64_bk64_s2_f16, __half, Sm120Tn, 128, 64, 64, 2)
SM120_DEFINE_KERNEL(tn_sm120_tma_128x64_bk64_s3_bf16, __nv_bfloat16, Sm120Tn, 128, 64, 64, 3)
SM120_DEFINE_KERNEL(tn_sm120_tma_128x64_bk64_s3_f16, __half, Sm120Tn, 128, 64, 64, 3)
SM120_DEFINE_KERNEL(tn_sm120_tma_64x128_bk32_s2_bf16, __nv_bfloat16, Sm120Tn, 64, 128, 32, 2)
SM120_DEFINE_KERNEL(tn_sm120_tma_64x128_bk32_s2_f16, __half, Sm120Tn, 64, 128, 32, 2)
SM120_DEFINE_KERNEL(tn_sm120_tma_64x128_bk32_s3_bf16, __nv_bfloat16, Sm120Tn, 64, 128, 32, 3)
SM120_DEFINE_KERNEL(tn_sm120_tma_64x128_bk32_s3_f16, __half, Sm120Tn, 64, 128, 32, 3)
SM120_DEFINE_KERNEL(tn_sm120_tma_64x128_bk64_s2_bf16, __nv_bfloat16, Sm120Tn, 64, 128, 64, 2)
SM120_DEFINE_KERNEL(tn_sm120_tma_64x128_bk64_s2_f16, __half, Sm120Tn, 64, 128, 64, 2)
SM120_DEFINE_KERNEL(tn_sm120_tma_64x128_bk64_s3_bf16, __nv_bfloat16, Sm120Tn, 64, 128, 64, 3)
SM120_DEFINE_KERNEL(tn_sm120_tma_64x128_bk64_s3_f16, __half, Sm120Tn, 64, 128, 64, 3)
SM120_DEFINE_KERNEL(tn_sm120_tma_128x128_bk32_s2_bf16, __nv_bfloat16, Sm120Tn, 128, 128, 32, 2)
SM120_DEFINE_KERNEL(tn_sm120_tma_128x128_bk32_s2_f16, __half, Sm120Tn, 128, 128, 32, 2)
SM120_DEFINE_KERNEL(tn_sm120_tma_128x128_bk32_s3_bf16, __nv_bfloat16, Sm120Tn, 128, 128, 32, 3)
SM120_DEFINE_KERNEL(tn_sm120_tma_128x128_bk32_s3_f16, __half, Sm120Tn, 128, 128, 32, 3)
SM120_DEFINE_KERNEL(tn_sm120_tma_128x128_bk64_s2_bf16, __nv_bfloat16, Sm120Tn, 128, 128, 64, 2)
SM120_DEFINE_KERNEL(tn_sm120_tma_128x128_bk64_s2_f16, __half, Sm120Tn, 128, 128, 64, 2)
SM120_DEFINE_KERNEL(tn_sm120_tma_128x128_bk64_s3_bf16, __nv_bfloat16, Sm120Tn, 128, 128, 64, 3)
SM120_DEFINE_KERNEL(tn_sm120_tma_128x128_bk64_s3_f16, __half, Sm120Tn, 128, 128, 64, 3)

SM120_DEFINE_KERNEL(nt_sm120_tma_64x64_bk32_s2_bf16, __nv_bfloat16, Sm120Nt, 64, 64, 32, 2)
SM120_DEFINE_KERNEL(nt_sm120_tma_64x64_bk32_s2_f16, __half, Sm120Nt, 64, 64, 32, 2)
SM120_DEFINE_KERNEL(nt_sm120_tma_64x64_bk32_s3_bf16, __nv_bfloat16, Sm120Nt, 64, 64, 32, 3)
SM120_DEFINE_KERNEL(nt_sm120_tma_64x64_bk32_s3_f16, __half, Sm120Nt, 64, 64, 32, 3)
SM120_DEFINE_KERNEL(nt_sm120_tma_64x64_bk64_s2_bf16, __nv_bfloat16, Sm120Nt, 64, 64, 64, 2)
SM120_DEFINE_KERNEL(nt_sm120_tma_64x64_bk64_s2_f16, __half, Sm120Nt, 64, 64, 64, 2)
SM120_DEFINE_KERNEL(nt_sm120_tma_64x64_bk64_s3_bf16, __nv_bfloat16, Sm120Nt, 64, 64, 64, 3)
SM120_DEFINE_KERNEL(nt_sm120_tma_64x64_bk64_s3_f16, __half, Sm120Nt, 64, 64, 64, 3)
SM120_DEFINE_KERNEL(nt_sm120_tma_128x64_bk32_s2_bf16, __nv_bfloat16, Sm120Nt, 128, 64, 32, 2)
SM120_DEFINE_KERNEL(nt_sm120_tma_128x64_bk32_s2_f16, __half, Sm120Nt, 128, 64, 32, 2)
SM120_DEFINE_KERNEL(nt_sm120_tma_128x64_bk32_s3_bf16, __nv_bfloat16, Sm120Nt, 128, 64, 32, 3)
SM120_DEFINE_KERNEL(nt_sm120_tma_128x64_bk32_s3_f16, __half, Sm120Nt, 128, 64, 32, 3)
SM120_DEFINE_KERNEL(nt_sm120_tma_128x64_bk64_s2_bf16, __nv_bfloat16, Sm120Nt, 128, 64, 64, 2)
SM120_DEFINE_KERNEL(nt_sm120_tma_128x64_bk64_s2_f16, __half, Sm120Nt, 128, 64, 64, 2)
SM120_DEFINE_KERNEL(nt_sm120_tma_128x64_bk64_s3_bf16, __nv_bfloat16, Sm120Nt, 128, 64, 64, 3)
SM120_DEFINE_KERNEL(nt_sm120_tma_128x64_bk64_s3_f16, __half, Sm120Nt, 128, 64, 64, 3)
SM120_DEFINE_KERNEL(nt_sm120_tma_64x128_bk32_s2_bf16, __nv_bfloat16, Sm120Nt, 64, 128, 32, 2)
SM120_DEFINE_KERNEL(nt_sm120_tma_64x128_bk32_s2_f16, __half, Sm120Nt, 64, 128, 32, 2)
SM120_DEFINE_KERNEL(nt_sm120_tma_64x128_bk32_s3_bf16, __nv_bfloat16, Sm120Nt, 64, 128, 32, 3)
SM120_DEFINE_KERNEL(nt_sm120_tma_64x128_bk32_s3_f16, __half, Sm120Nt, 64, 128, 32, 3)
SM120_DEFINE_KERNEL(nt_sm120_tma_64x128_bk64_s2_bf16, __nv_bfloat16, Sm120Nt, 64, 128, 64, 2)
SM120_DEFINE_KERNEL(nt_sm120_tma_64x128_bk64_s2_f16, __half, Sm120Nt, 64, 128, 64, 2)
SM120_DEFINE_KERNEL(nt_sm120_tma_64x128_bk64_s3_bf16, __nv_bfloat16, Sm120Nt, 64, 128, 64, 3)
SM120_DEFINE_KERNEL(nt_sm120_tma_64x128_bk64_s3_f16, __half, Sm120Nt, 64, 128, 64, 3)
SM120_DEFINE_KERNEL(nt_sm120_tma_128x128_bk32_s2_bf16, __nv_bfloat16, Sm120Nt, 128, 128, 32, 2)
SM120_DEFINE_KERNEL(nt_sm120_tma_128x128_bk32_s2_f16, __half, Sm120Nt, 128, 128, 32, 2)
SM120_DEFINE_KERNEL(nt_sm120_tma_128x128_bk32_s3_bf16, __nv_bfloat16, Sm120Nt, 128, 128, 32, 3)
SM120_DEFINE_KERNEL(nt_sm120_tma_128x128_bk32_s3_f16, __half, Sm120Nt, 128, 128, 32, 3)
SM120_DEFINE_KERNEL(nt_sm120_tma_128x128_bk64_s2_bf16, __nv_bfloat16, Sm120Nt, 128, 128, 64, 2)
SM120_DEFINE_KERNEL(nt_sm120_tma_128x128_bk64_s2_f16, __half, Sm120Nt, 128, 128, 64, 2)
SM120_DEFINE_KERNEL(nt_sm120_tma_128x128_bk64_s3_bf16, __nv_bfloat16, Sm120Nt, 128, 128, 64, 3)
SM120_DEFINE_KERNEL(nt_sm120_tma_128x128_bk64_s3_f16, __half, Sm120Nt, 128, 128, 64, 3)
...
SM120_DEFINE_HALF_TN_STREAMK_KERNEL(tn_sm120_tma_64x64_bk64_s3_streamk_bf16, __nv_bfloat16, 64, 64, 64, 3)
SM120_DEFINE_HALF_TN_STREAMK_KERNEL(tn_sm120_tma_64x64_bk64_s3_streamk_f16, __half, 64, 64, 64, 3)
...
SM120_DEFINE_TF32_KERNEL(nn_sm120_tma_mma_tf32_m128n64_bk32_s2, Sm120Nn, 128, 64, 2)
SM120_DEFINE_TF32_KERNEL(nn_sm120_tma_mma_tf32_m128n64_bk32_s3, Sm120Nn, 128, 64, 3)
SM120_DEFINE_TF32_KERNEL(nn_sm120_tma_mma_tf32_m64n128_bk32_s2, Sm120Nn, 64, 128, 2)
SM120_DEFINE_TF32_KERNEL(nn_sm120_tma_mma_tf32_m64n128_bk32_s3, Sm120Nn, 64, 128, 3)
SM120_DEFINE_TF32_KERNEL(nn_sm120_tma_mma_tf32_m64n64_bk32_s2, Sm120Nn, 64, 64, 2)
extern "C" __global__ __launch_bounds__(160)
void nn_sm120_tma_mma_tf32_m80n32_bk64_s2(
    void* output, const __grid_constant__ CUtensorMap a_map,
    const __grid_constant__ CUtensorMap b_map, const float* bias,
    const __grid_constant__ Sm120KernelParams params) {
    sm120_tf32_rect_wide_entry(output, a_map, b_map, bias, params);
}
SM120_DEFINE_TF32_KERNEL(tn_sm120_tma_mma_tf32_m128n64_bk32_s2, Sm120Tn, 128, 64, 2)
SM120_DEFINE_TF32_KERNEL(tn_sm120_tma_mma_tf32_m128n64_bk32_s3, Sm120Tn, 128, 64, 3)
SM120_DEFINE_TF32_KERNEL(tn_sm120_tma_mma_tf32_m64n128_bk32_s2, Sm120Tn, 64, 128, 2)
SM120_DEFINE_TF32_KERNEL(tn_sm120_tma_mma_tf32_m64n128_bk32_s3, Sm120Tn, 64, 128, 3)
SM120_DEFINE_TF32_PAIR_KERNEL(tn_sm120_tma_mma_tf32_m64n128_bk32_s4_pair, Sm120Tn, 64, 128, 4)
...
SM120_DEFINE_TF32_TN_STREAMK_KERNEL(tn_sm120_tma_mma_tf32_m64n128_bk32_s3_pair_streamk, 64, 128, 3)
SM120_DEFINE_TF32_KERNEL(tn_sm120_tma_mma_tf32_m64n64_bk32_s2, Sm120Tn, 64, 64, 2)
SM120_DEFINE_TF32_KERNEL(nt_sm120_tma_mma_tf32_m128n64_bk32_s2, Sm120Nt, 128, 64, 2)
SM120_DEFINE_TF32_KERNEL(nt_sm120_tma_mma_tf32_m128n64_bk32_s3, Sm120Nt, 128, 64, 3)
SM120_DEFINE_TF32_KERNEL(nt_sm120_tma_mma_tf32_m64n128_bk32_s2, Sm120Nt, 64, 128, 2)
SM120_DEFINE_TF32_KERNEL(nt_sm120_tma_mma_tf32_m64n128_bk32_s3, Sm120Nt, 64, 128, 3)
SM120_DEFINE_TF32_KERNEL(nt_sm120_tma_mma_tf32_m64n64_bk32_s2, Sm120Nt, 64, 64, 2)
...
TF32_ASSERT_KERNEL_SIGNATURE(nn_sm120_tma_mma_tf32_m128n64_bk32_s2);
TF32_ASSERT_KERNEL_SIGNATURE(nn_sm120_tma_mma_tf32_m128n64_bk32_s3);
TF32_ASSERT_KERNEL_SIGNATURE(nn_sm120_tma_mma_tf32_m64n128_bk32_s2);
TF32_ASSERT_KERNEL_SIGNATURE(nn_sm120_tma_mma_tf32_m64n128_bk32_s3);
TF32_ASSERT_KERNEL_SIGNATURE(nn_sm120_tma_mma_tf32_m64n64_bk32_s2);
TF32_ASSERT_KERNEL_SIGNATURE(nn_sm120_tma_mma_tf32_m80n32_bk64_s2);
TF32_ASSERT_KERNEL_SIGNATURE(tn_sm120_tma_mma_tf32_m128n64_bk32_s2);
TF32_ASSERT_KERNEL_SIGNATURE(tn_sm120_tma_mma_tf32_m128n64_bk32_s3);
TF32_ASSERT_KERNEL_SIGNATURE(tn_sm120_tma_mma_tf32_m64n128_bk32_s2);
TF32_ASSERT_KERNEL_SIGNATURE(tn_sm120_tma_mma_tf32_m64n128_bk32_s3);
TF32_ASSERT_KERNEL_SIGNATURE(tn_sm120_tma_mma_tf32_m64n128_bk32_s4_pair);
TF32_ASSERT_KERNEL_SIGNATURE(tn_sm120_tma_mma_tf32_m64n128_bk32_s3_pair_streamk, StreamK);
TF32_ASSERT_KERNEL_SIGNATURE(tn_sm120_tma_mma_tf32_m64n64_bk32_s2);
TF32_ASSERT_KERNEL_SIGNATURE(nt_sm120_tma_mma_tf32_m128n64_bk32_s2);
TF32_ASSERT_KERNEL_SIGNATURE(nt_sm120_tma_mma_tf32_m128n64_bk32_s3);
TF32_ASSERT_KERNEL_SIGNATURE(nt_sm120_tma_mma_tf32_m64n128_bk32_s2);
TF32_ASSERT_KERNEL_SIGNATURE(nt_sm120_tma_mma_tf32_m64n128_bk32_s3);
TF32_ASSERT_KERNEL_SIGNATURE(nt_sm120_tma_mma_tf32_m64n64_bk32_s2);
