__device__ __forceinline__ int cp_async_valid_elems(
...
template <typename T>
__device__ __forceinline__ const T* cp_async_source(
...
__device__ __forceinline__ void cp_async_16_zfill_l2(
    unsigned shared_dst, const void* global_src, int valid_bytes) {
