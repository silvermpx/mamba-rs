...
__device__ __forceinline__ void tf32_tn_splitk_stage_async(
...
template <SgbTf32Op Op, int BM, int BN, int Stages, int MAtoms, int NAtoms,
          bool NarrowA, bool NarrowB>
__device__ __forceinline__ void tf32_tn_splitk_async_mainloop(
...
__device__ __forceinline__ void tf32_tn_splitk_fused_kernel(
...
void tn_sm80_mma_tf32_splitk8_m64n64_bk32_s2(
    float* output, float* partial, unsigned* counters,
    const float* a, const float* b, const float* bias,
    Sm80Tf32KernelParams params) {
...
void tn_sm80_mma_tf32_splitk8_m64n64_bk32_s3(
    float* output, float* partial, unsigned* counters,
    const float* a, const float* b, const float* bias,
    Sm80Tf32KernelParams params) {
...
void tn_sm80_mma_tf32_splitk8_m32n32_bk32_s3(
    float* output, float* partial, unsigned* counters,
    const float* a, const float* b, const float* bias,
    Sm80Tf32KernelParams params) {
...
extern "C" __global__ __launch_bounds__(128, 2)
void tn_sm80_mma_tf32_splitk8_m32n32_bk32_s4(
    float* output, float* partial, unsigned* counters,
    const float* a, const float* b, const float* bias,
    Sm80Tf32KernelParams params) {
...
TF32_ASSERT_SPLITK_KERNEL_SIGNATURE(tn_sm80_mma_tf32_splitk8_m64n64_bk32_s2);
TF32_ASSERT_SPLITK_KERNEL_SIGNATURE(tn_sm80_mma_tf32_splitk8_m64n64_bk32_s3);
TF32_ASSERT_SPLITK_KERNEL_SIGNATURE(tn_sm80_mma_tf32_splitk8_m32n32_bk32_s3);
TF32_ASSERT_SPLITK_KERNEL_SIGNATURE(tn_sm80_mma_tf32_splitk8_m32n32_bk32_s4);
