...
void tn_sm89_tf32_pre_rna_m128n96_bk32_s3(
    float* output, const float* a, const float* b, const float* bias,
    GbfTf32N96Params params) {
    if (params.k == 0) {
...
extern "C" __global__ __launch_bounds__(256, 1)
void tn_sm89_tf32_pre_rna_m64n64_bk32_s3(
    float* output, const float* a, const float* b, const float* bias,
    GbfTf32N96Params params) {
    if (params.k == 0) {
...
// A stage whose K slab lies inside the reduction: each chunk's length is
...
extern "C" __global__ __launch_bounds__(256, 1)
void nn_sm89_tf32_addhalf_m128n96_bk32_s3_direct(
    float* output, const float* a, const float* b, const float* bias,
    GbfTf32N96Params params) {
    if (params.k == 0) {
        tf32n96_zero_reduction(output, bias, params);
...
extern "C" __global__ __launch_bounds__(256, 1)
void nn_sm89_tf32_addhalf_m128n96_bk32_s3(
    float* output, const float* a, const float* b, const float* bias,
    GbfTf32N96Params params) {
    if (params.k == 0) {
        tf32n96_zero_reduction(output, bias, params);
...
void tn_sm89_tf32_pre_rna_m64n96_bk32_s2(
    float* output, const float* a, const float* b, const float* bias,
    GbfTf32N96Params params) {
    if (params.k == 0) {
...
extern "C" __global__ __launch_bounds__(256, 1)
void nt_sm89_tf32_a_ldmatrix_m128n96_bk32_s3(
    float* output, const float* a, const float* b, const float* bias,
