...
impl CandidateVariant {
    ...
    const fn symbol(self) -> &'static str {
        match self {
            ...
            Self::TnTransposeN96D768In => triad_tn_transpose_n96_source::GEMM_SYMBOL,
    ...
    const fn shared_bytes(self) -> u32 {
        match self {
            ...
            Self::TnTransposeN96D768In => 86_016,
    ...
    const fn is_transpose_n96(self) -> bool {
        matches!(self, Self::TnTransposeN96D768In)
    }
    ...
    const fn tn_screen_schema(self) -> &'static str {
        match self {
            ...
            Self::TnTransposeN96D768In => "MambaBiTf32TnTransposeN96DiscoveryScreenV1",
            Self::TnSmallRegpipeD128In | Self::TnSmallRegpipeD128Out => {
    ...
    const fn tn_decision_schema(self) -> &'static str {
        match self {
            ...
            Self::TnTransposeN96D768In => "MambaBiTf32TnTransposeN96DiscoveryDecisionV1",
            Self::TnSmallRegpipeD128In | Self::TnSmallRegpipeD128Out => {
...
#[test]
fn tn_transpose_n96_binds_d768_in_physical_shape_and_two_node_pipeline() {
    let variant = CandidateVariant::TnTransposeN96D768In;
    assert!(variant.is_tn());
