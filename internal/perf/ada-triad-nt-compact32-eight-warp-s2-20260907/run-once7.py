#!/usr/bin/env python3
"""Bind the validated single-arm runner to compact32 S2 discovery."""
...
EVIDENCE = Path("/root/evidence-ada-triad-nt-compact32-eight-warp-s2-20260907")
...
runner.ARMS = {
    "compact-eight-warp-s2": (
        "compact_eight_warp_s2",
        TEST,
    )
}
sys.argv = [sys.argv[0], "compact-eight-warp-s2"]
