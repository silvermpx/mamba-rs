...
EVIDENCE = Path(
    "/root/evidence-ada-triad-finalist-integration-20260907/task3-auto-cuda132-final2"
)
...
TESTS = [
    ("lib", "mamba_ssm::gpu::gemm_bi_triad::dispatch::tf32_tests::sm89_finalist_measured_cohorts_select_and_decline_to_prior_routes", False),
    ("lib", "mamba_ssm::gpu::gemm_bi_triad::dispatch::tf32_tests::sm89_finalist_is_forced_only_and_uses_only_its_own_pointer_binding", False),
