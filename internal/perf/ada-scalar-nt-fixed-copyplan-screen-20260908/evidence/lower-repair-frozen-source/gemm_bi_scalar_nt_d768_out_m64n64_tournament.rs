...
mod cuda_tournament {
    ...
    use super::{
        ...
        TRANSPOSE_32X16, ada_candidate_over_auto, ada_copyplan_contract,
        ada_discovery_toolkit_supported, ada_percentile, ada_retain_decision, fixed_full_mantissa,
        validate_ada_copyplan_contract,
    };
