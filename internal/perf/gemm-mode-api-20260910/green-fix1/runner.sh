...
for name in mamba_ssm::gpu::context::tests::deterministic_environment_defaults_and_validates_custom_policy mamba_ssm::gpu::gemm_bi_triad::qualification::tests::qualification_policy_guard_restores_every_setting_after_error mamba_ssm::gpu::blas::physical_graph_tests::context_aware_vendor_compute_maps_all_dtypes; do
