    ...
    fn inference_composed_source_identity_is_frozen() {
        let cases = [
            (
                ...
                615_275,
                "7e3507c9709587901e629bf0adcd11c7b0b3ec21c48044952c9bbbffe7db9842",
            ),
            (
                "sm_89",
                compose_module_source_for(ModuleKind::Fixed, "sm_89").unwrap(),
                722_886,
                "4f48ed4bcbcf934a4346a3214ba44dbd660662853d5ca1ecbba7fc4c6b2cb4ec",
            ),
            (
                "compute_120",
                compose_module_source_for(ModuleKind::Fixed, "compute_120").unwrap(),
                718_693,
                "7e3dd0270c4f62a9f9ce7c73fa5b048e16512c7c959bfdb120c6404d991586a7",
            ),
        ];

        for (name, source, _, _) in &cases {
            eprintln!(
                "{name}: bytes={} chars={} sha256={}",
                source.len(),
                source.chars().count(),
                crate::mamba_ssm::gpu::kernel_identity::digest_hex(
