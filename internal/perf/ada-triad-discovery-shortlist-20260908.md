...
| Exact F32 TN d768-in | Full-K transpose+CopyPlan is rejected before timing: it differs from actual two-chunk SplitM+FP64-reducer AUTO by3ULP at word0. Next candidate must preserve the selected SplitM grouping. | [Correctness stop](ada-triad-f32-tn-copyplan-d768-in-20260908/report.md) |
