...
All ten cells below pass their focused current-family exact-bit checks and
...
| Half NT d768-out | NEW F16 M96N128/BK64/S3 is a strict Fast winner: it beats M64N192 by6.5–6.8% and Fast by8.6–10.2% p50, with every once7 p95 below0.921. It reduces staged traffic9.77%, registers127->120, shared98,304->86,016 and LDGSTS18->15. BF16 remains unresolved: M64N128/S3 beats retained B-XOR S3 by4.5–4.6%, but Fast graph worst p95 is1.0217. Direct BF16 M64N192 improves eager1.23–1.44% but graph p50/p95 only0.99007/0.99072. F16 M64N192 itself narrowly missed graph admission before the M96N128 win. Issue2/2/1/1 stays parity, full-domain loses, S2 and GROUP_M8 lose. | [F16 M96N128 winner](ada-triad-f16-nt-m96n128-s3-20260909/report.md), [M64N128 F16](ada-triad-half-nt-m64n128-s3-20260908/report.md), [BF16](ada-triad-half-nt-m64n128-s3-bf16-20260908/report.md), [F16 N192 near miss](ada-triad-half-nt-m64n192-s3-20260909/report.md), [BF16 N192 stop](ada-triad-bf16-nt-m64n192-s3-20260909/report.md), [issue-order stop](ada-triad-f16-nt-m64n192-issue2211-20260909/report.md), [N192 full-domain stop](ada-triad-half-nt-m64n192-full-domain-20260909/report.md), [S2 stop](ada-triad-half-nt-m64n128-s2-20260909/report.md), [GROUP_M8 stop](ada-triad-half-nt-m64n128-s3-groupm8-20260909/report.md), [retained out](ada-triad-half-nt-fixed-s3-bxor-20260908/report.md) |
...
| TF32 TN large shapes | Whole raw-transpose+N96 reduces actual AUTO time29–30% in,40% out,15–17% Prism. A-only transpose-RNA wins all three retained cells. NEW canonical-Prism M64N64/S3 wave body then beats its N96 parent8.1–8.8% p50 and5.3–7.4% p95, with83regs/local0/49,152B/occupancy2; it remains1.68–1.74x slower than Fast at p50. Joint A+B preprocessing loses A-only1.6–2.2%. A d768-out M128N192 S3/S2 route is a quantified no-go. No Fast win yet. | [Earlier in](ada-triad-tf32-tn-transpose-n96-20260908/report.md), [earlier out/Prism](ada-triad-tf32-tn-transpose-n96-siblings-20260908/report.md), [d768-out A-RNA winner](ada-triad-tf32-tn-transpose-rna-n96-d768-out-20260909/report.md), [in/Prism A-RNA winners](ada-triad-tf32-tn-transpose-rna-n96-siblings-20260909/report.md), [Prism M64N64 winner](ada-triad-tf32-tn-transpose-rna-m64n64-prism-20260909/report.md), [A+B stop](ada-triad-tf32-tn-transpose-ab-rna-n96-d768-out-20260909/report.md) |
...
| Exact F32 TN large | NEW d768-in dual-chunk fused candidate reduces the retained three-node N64 GROUP_M8 pipeline to two nodes and wins by4.0–4.4% with exact bits. Fast remains2.30–2.33x ahead. Earlier SplitM CopyPlan cuts actual AUTO14.5-15.4% for d768-in and9.5-11.5% for d768-out. NEW canonical-Prism direct M64N64/BK16/S2 raw-partial plus unchanged FP64 reducer is exact and beats actual AUTO by21.3–21.4% in every once7 stratum; it uses107regs/local0/16KiB/occupancy4. Fast remains2.40x ahead. A one-node direct M64N32 fused-finalize follow-up is exact and reaches127regs/local0/12KiB/occupancy4, but loses the retained M64N64+reducer pipeline12.0–12.2% and stops once3. | [dual-chunk retained-best](ada-triad-f32-tn-dual-chunk-20260909/report.md), [direct dual stop](ada-triad-f32-tn-direct-dual-chunk-20260909/report.md), [rolled compile stop](ada-triad-f32-tn-rolled-dual-chunk-20260909/report.md), [d768-in CopyPlan](ada-triad-f32-tn-splitm-copyplan-20260908/report.md), [out/Prism](ada-triad-f32-tn-splitm-copyplan-siblings-20260908/report.md), [Prism direct winner](ada-triad-f32-tn-direct-prism-bk16-20260909/report.md), [Prism fused N32 stop](ada-triad-f32-tn-direct-prism-fused-n32-20260909/report.md), [earlier full-K correctness stop](ada-triad-f32-tn-copyplan-d768-in-20260908/report.md) |
