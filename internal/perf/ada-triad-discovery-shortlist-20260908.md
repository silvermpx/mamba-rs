...
| TF32 NT large shapes | Keep A-only ldmatrix for d768-in/Prism. NEW stage-sliced A-ldmatrix wins d768-out retained by1.28–1.47%, exact and resource-neutral; Fast remains1.41–1.42x ahead. Shared-RNA and A+B ldmatrix lose the d768-in parent and stop. | [d768-in](ada-triad-tf32-nt-a-ldmatrix-20260908/report.md), [out/Prism](ada-triad-tf32-nt-a-ldmatrix-siblings-20260908/report.md), [sliced d768-out](ada-triad-tf32-nt-a-ldmatrix-sliced-20260909/report.md), [shared RNA](ada-triad-tf32-nt-shared-rna-20260908/report.md), [A+B](ada-triad-tf32-nt-compact-ab-ldmatrix-20260908/report.md) |
