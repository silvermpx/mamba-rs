...
| Exact F32 TN large | NEW SplitM CopyPlan preserves the selected grouping/reducer and cuts actual AUTO14.5-15.4% for d768-in and9.5-11.5% for d768-out. Fast remains2.58-2.77x ahead. Prism is exact but loses AUTO34.8-36.4% and stops. | [d768-in winner](ada-triad-f32-tn-splitm-copyplan-20260908/report.md), [out/Prism](ada-triad-f32-tn-splitm-copyplan-siblings-20260908/report.md), [earlier full-K correctness stop](ada-triad-f32-tn-copyplan-d768-in-20260908/report.md) |
