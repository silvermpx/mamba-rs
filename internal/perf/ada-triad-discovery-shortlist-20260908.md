...
| Exact F32 TN d768-in | NEW two-chunk CopyPlan reuses the selected SplitM grouping and unchanged FP64 reducer. It is exact and cuts actual AUTO time14.5-15.4%; Fast remains2.58-2.60x ahead. The earlier full-K chain remains rejected. | [Retained winner](ada-triad-f32-tn-splitm-copyplan-20260908/report.md), [earlier correctness stop](ada-triad-f32-tn-copyplan-d768-in-20260908/report.md) |
