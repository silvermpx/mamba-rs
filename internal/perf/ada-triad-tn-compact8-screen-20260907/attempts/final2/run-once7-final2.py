#!/usr/bin/env python3
"""Run the one reviewed TN compact-eight-warp discovery arm."""
...
EVIDENCE = Path("/root/evidence-ada-triad-tn-compact8-screen-20260907")
RUN = EVIDENCE / "once7-cuda132-final2"
SOURCE_MANIFEST = EVIDENCE / "source-manifest-final2.json"
...
BINARY_SHA = "9c416a412ac9d1a3a1fa2853a166d12e8ff1dab036b330a306bab755d37be6ef"
TEST = "cuda_suite::ada_tf32_tn_prism_compact_eight_warp_s2_discovery_once7"
VARIANT = "tn_compact_eight_warp_s2_prism"
FROZEN = {
    "tests/gemm_bi_tf32_nt_compact_xor.rs": "38b99e571ced8aae8d267eccb1fa052e6a1b160075c1e76132458e8e7923d673",
    "tests/support/triad_tn_compact_source.rs": "f6d10a1534184dca67609b5cb836268d50c7f795fa53c8fd39ab55508b1e58f0",
...
def main() -> int:
    ...
    env_runner = load("tn_compact_env", ENV_RUNNER)
    telemetry_runner = load("tn_compact_telemetry", TELEMETRY_RUNNER)
    ...
    manifest = {
        "schema": "MambaBiTf32TnCompact8DiscoverySourcesV1",
        "base_head": "2fed713bee332f7b106ba5886297b11a7b582370",
        "count": len(sources),
        "excluded_local_wip": [
    ...
    listed = {
        ...
        for line in (EVIDENCE / "list1.log").read_text().splitlines()
    ...
    schema_counts = {
        ...
        "screen": text.count('"schema":"MambaBiTf32TnCompact8DiscoveryScreenV1"'),
        "decision": text.count('"schema":"MambaBiTf32TnCompact8DiscoveryDecisionV1"'),
    ...
    receipt = {
        "schema": "MambaBiTf32TnCompact8DiscoveryRunReceiptV1",
        "args": args,
        "started_utc": started,
