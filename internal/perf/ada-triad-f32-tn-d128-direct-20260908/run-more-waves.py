#!/usr/bin/env python3
"""Run the reviewed CUDA 13.2 F32 TN M8N16 more-waves screen."""
...
EVIDENCE = Path("/root/evidence-ada-triad-f32-tn-d128-direct-20260908/more-waves")
...
BINARY_SHA = "c436b8531f36dc1fe2cc0b727dd21dd4d61ea0c03f9b13fe2b7b9917a0a5fd77"
TEST = "cuda_tournament::ada_d128_direct_fold_more_waves_once7"
...
def main() -> int:
    ...
    env_runner = load("f32_tn_more_waves_env", ENV_RUNNER)
    telemetry_runner = load("f32_tn_more_waves_telemetry", TELEMETRY_RUNNER)
