...
#include "sm89-fixed-half-swizzle-layout.h"
#include <array>
#include <cstdio>
#include <stdexcept>
#include <string>
...
int main() try {
    ...
    std::printf("{\"schema\":\"Sm89HalfSwizzleHostV1\",\"all_passed\":true,\"copied_chunks\":%zu,\"checked_fragment_halfs\":%zu,\"conflict_free_ldmatrix_groups\":%zu,\"staging_bytes\":65536,\"dynamic_shared_bytes\":%d}\n",
