...
fn cuda_harness_stops_in_order_after_exact_resources_once3_and_once7() {
    let harness = include_str!("gemm_bi_scalar_tn_direct_prism_bk16_discovery.rs");
...
mod splitm_cuda_suite {
    ...
    #[test]
    #[ignore = "Ada CUDA13.2 discovery: exact F32 TN canonical Prism direct BK16"]
    fn ada_f32_tn_direct_prism_bk16_discovery() -> Result<(), String> {
