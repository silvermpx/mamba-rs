//! Test-only Ada TF32 NT d768-out stage-sliced A-ldmatrix discovery.
...
mod cuda_suite {
    ...
    const ENV: &str = "MAMBA_TRIAD_TF32_NT_A_LDMATRIX_SLICED_D768_OUT_DISCOVERY";
    const OPS: usize = 20;
    ...
    #[test]
    #[ignore = "requires exclusive quiet CC8.9/142-SM CUDA12.8/13.0/13.2; TF32 NT sliced d768-out once3/once7"]
    fn ada_tf32_nt_a_ldmatrix_sliced_d768_out_scout3_then_once7() -> Result<(), String> {
