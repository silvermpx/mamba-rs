...
fn partial_tf32_vectors_use_scalar_width_cp_async_at_all_alignments() {
    ...
    let wide = selector
        .split("} else if (valid_bytes == 16 && is_aligned_16(global_src))")
        .next()
