...
const CANDIDATE: FixedTile = FixedTile::F32Sm120N64Sliced;
...
fn assert_exact_n64_graph(
    ...
    let (symbol, compact, tma, tile_m, tile_n, threads, dynamic_shared) = match tile {
        ...
        FixedTile::F32N128S2 => ("gemm_bi_f32_f32_n128_s2", false, false, 64, 128, 256, 0),
        FixedTile::Legacy => (LEGACY_SYMBOL, false, false, 64, 64, 128, 0),
