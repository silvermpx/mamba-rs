...
mod sm89_exact_f32_tn_admission_tests {
    ...
    const KNOWN_IDENTITIES: [Sm89ExactF32QualificationIdentity; 3] = [
        Sm89ExactF32QualificationIdentity {
            nvrtc_version: (12, 8),
            compile_key: [
                70, 67, 148, 65, 182, 101, 140, 173, 142, 197, 11, 159, 116, 94, 215, 15, 37, 0,
                92, 177, 95, 59, 132, 54, 53, 110, 140, 169, 61, 167, 250, 162,
            ],
            artifact_digest: [
            ...
            source_digest: [
                184, 62, 234, 85, 233, 204, 237, 34, 3, 102, 200, 22, 9, 52, 52, 15, 142, 79, 74,
                89, 240, 7, 214, 50, 219, 188, 187, 36, 221, 42, 80, 60,
            ],
        ...
        Sm89ExactF32QualificationIdentity {
            nvrtc_version: (13, 0),
            compile_key: [
                86, 193, 25, 214, 37, 111, 93, 218, 185, 95, 189, 146, 237, 232, 222, 146, 181,
                206, 108, 68, 226, 160, 112, 207, 149, 140, 228, 157, 1, 61, 232, 153,
            ],
            artifact_digest: [
                185, 145, 225, 230, 248, 199, 125, 14, 53, 11, 169, 232, 111, 188, 127, 101, 100,
                104, 243, 235, 156, 46, 180, 90, 21, 224, 225, 212, 243, 62, 218, 225,
            ],
            source_digest: [
                184, 62, 234, 85, 233, 204, 237, 34, 3, 102, 200, 22, 9, 52, 52, 15, 142, 79, 74,
                89, 240, 7, 214, 50, 219, 188, 187, 36, 221, 42, 80, 60,
        ...
        Sm89ExactF32QualificationIdentity {
            nvrtc_version: (13, 2),
            compile_key: [
                43, 1, 152, 9, 40, 109, 177, 6, 162, 219, 3, 83, 222, 38, 42, 24, 113, 126, 164,
                235, 219, 162, 227, 127, 157, 243, 72, 211, 87, 247, 19, 26,
            ],
            artifact_digest: [
                80, 156, 39, 47, 228, 206, 167, 21, 140, 13, 121, 7, 102, 138, 197, 155, 66, 191,
                145, 112, 22, 52, 62, 110, 183, 141, 165, 179, 31, 85, 80, 164,
            ],
            source_digest: [
                184, 62, 234, 85, 233, 204, 237, 34, 3, 102, 200, 22, 9, 52, 52, 15, 142, 79, 74,
                89, 240, 7, 214, 50, 219, 188, 187, 36, 221, 42, 80, 60,
...
const SM89_TF32_QUALIFICATION_IDENTITY: Tf32AutoQualificationIdentity =
    Tf32AutoQualificationIdentity {
        ...
        compile_key: [
            56, 9, 175, 3, 71, 24, 170, 8, 223, 223, 193, 182, 186, 235, 64, 119, 21, 67, 109, 199,
            219, 135, 239, 57, 130, 91, 3, 60, 47, 215, 37, 65,
        ],
        artifact_digest: [
            197, 203, 222, 153, 151, 139, 150, 86, 207, 189, 130, 77, 157, 19, 179, 92, 117, 115,
            85, 79, 36, 14, 245, 227, 142, 135, 117, 208, 19, 112, 78, 12,
        ],
        source_digest: [
        ...
        header_manifest_digest: [
            3, 57, 179, 82, 249, 158, 164, 178, 83, 169, 115, 209, 213, 255, 216, 133, 82, 22, 154,
            174, 196, 237, 89, 192, 98, 186, 55, 148, 159, 125, 13, 54,
        ],
        nvrtc_library_domain: [
...
const SM89_TF32_EVIDENCE_CELLS: &[Tf32AutoCell] = &[
    ...
    // nn_prism_out_proj: gemm_bi_nn_sm80_mma_tf32_v1_m128n128_bk32_s3
    sm89_tf32_cell(
        Nn,
        4621,
        384,
    ...
    // nn_prism_input_proj: gemm_bi_nn_sm80_mma_tf32_v1_m128n128_bk32_s3
    sm89_tf32_cell(
        Nn,
        4621,
        384,
    ...
    // tn_prism_input_proj: gemm_bi_tn_sm80_mma_tf32_splitk8_v1_m64n64_bk32_s3
    sm89_tf32_route_cell(
        Tn,
        (1024, 384, 4621),
    ...
    // nn_batch_input_proj: gemm_bi_nn_sm80_mma_tf32_v1_m128n128_bk32_s3
    sm89_tf32_cell(
        Nn,
        10400,
        384,
    ...
    // nn_batch_out_proj: gemm_bi_nn_sm80_mma_tf32_v1_m128n128_bk32_s3
    sm89_tf32_cell(
        Nn,
        10400,
        384,
    ...
    // nn_rect_tall: gemm_bi_nn_sm80_mma_tf32_v1_m128n128_bk32_s3
    sm89_tf32_cell(
        Nn,
        4096,
        768,
    ...
    // tn_rect_tall: gemm_bi_tn_sm80_mma_tf32_splitk8_v1_m64n64_bk32_s3
    sm89_tf32_route_cell(
        Tn,
        (512, 768, 4096),
        Tf32PhysicalRoute::MmaTf32RnaSplitK8V1(super::contract::Tf32PortableRoute {
    ...
    // tn_prism_out_proj: gemm_bi_tn_sm80_mma_tf32_splitk8_v1_m64n64_bk32_s3
    sm89_tf32_route_cell(
        Tn,
        (768, 384, 4621),
        Tf32PhysicalRoute::MmaTf32RnaSplitK8V1(super::contract::Tf32PortableRoute {
    ...
    // nn_d768_in_proj: gemm_bi_nn_sm80_mma_tf32_v1_m128n128_bk32_s3
    sm89_tf32_cell(
        Nn,
        2048,
        3072,
    ...
    // nn_d768_out_proj: gemm_bi_nn_sm80_mma_tf32_v1_m128n128_bk32_s3
    sm89_tf32_cell(
        Nn,
        2048,
        768,
    ...
    // nn_prism_in_proj: gemm_bi_nn_sm80_mma_tf32_v1_m128n128_bk32_s3
    sm89_tf32_cell(
        Nn,
        4621,
        1928,
    ...
    // nn_large_deep: gemm_bi_nn_sm80_mma_tf32_v1_m128n128_bk32_s3
    sm89_tf32_cell(
        Nn,
        4096,
        1536,
    ...
    // nn_large: gemm_bi_nn_sm80_mma_tf32_v1_m128n128_bk32_s3
    sm89_tf32_cell(
        Nn,
        2048,
        768,
    ...
    // nn_d128_in_proj: gemm_bi_nn_sm80_mma_tf32_v1_m64n64_bk32_s2
    sm89_tf32_cell(
        Nn,
        1024,
        512,
    ...
    // nn_d128_out_proj: gemm_bi_nn_sm80_mma_tf32_v1_m16n32_bk32_s4
    sm89_tf32_cell(
        Nn,
        1024,
        128,
    ...
    // nn_batch_in_proj: gemm_bi_nn_sm80_mma_tf32_v1_m128n128_bk32_s3
    sm89_tf32_cell(
        Nn,
        10400,
        1536,
    ...
    // tn_batch_input_proj: gemm_bi_tn_sm80_mma_tf32_splitk8_v1_m64n64_bk32_s3
    sm89_tf32_route_cell(
        Tn,
        (384, 384, 10400),
        Tf32PhysicalRoute::MmaTf32RnaSplitK8V1(super::contract::Tf32PortableRoute {
    ...
    // tn_batch_out_proj: gemm_bi_tn_sm80_mma_tf32_splitk8_v1_m64n64_bk32_s3
    sm89_tf32_route_cell(
        Tn,
        (768, 384, 10400),
        Tf32PhysicalRoute::MmaTf32RnaSplitK8V1(super::contract::Tf32PortableRoute {
...
const SM89_FINALIST_TF32_IDENTITY_CUDA_13_2: Tf32AutoQualificationIdentity =
    Tf32AutoQualificationIdentity {
        ...
        header_manifest_digest: [
            ...
            54, 138, 204, 24, 3, 76, 232, 2, 66, 236, 170, 143, 185,
        ],
        nvrtc_library_domain: [
            208, 49, 165, 62, 185, 114, 53, 183, 15, 98, 246, 82, 147, 45, 177, 189, 247, 40, 234,
            34, 156, 140, 168, 9, 213, 60, 95, 253, 145, 100, 38, 135,
...
const SM89_FINALIST_TF32_IDENTITY_CUDA_12_8: Tf32AutoQualificationIdentity =
    Tf32AutoQualificationIdentity {
        ...
        header_manifest_digest: [
            ...
            242, 46, 112, 152, 8, 167, 215, 50, 197, 193, 157, 144, 184, 33,
        ],
        nvrtc_library_domain: [
            38, 176, 163, 160, 32, 68, 255, 203, 193, 105, 63, 216, 62, 146, 97, 190, 255, 166,
            146, 164, 251, 207, 227, 172, 94, 157, 140, 135, 152, 11, 177, 85,
...
const SM89_FINALIST_TF32_IDENTITY_CUDA_13_0: Tf32AutoQualificationIdentity =
    Tf32AutoQualificationIdentity {
        ...
        header_manifest_digest: [
            ...
            121, 154, 229, 76, 206, 197, 181, 98, 137, 34, 14, 173, 70,
        ],
        nvrtc_library_domain: [
            112, 155, 145, 195, 107, 251, 14, 217, 102, 238, 105, 173, 200, 214, 248, 127, 241, 16,
            238, 207, 61, 251, 80, 96, 54, 127, 24, 60, 230, 20, 235, 13,
...
pub fn resolve_tf32_forced(
    ...
    let binding = match route {
        ...
        | Tf32PhysicalRoute::Sm89NnDirectN96V1
        | Tf32PhysicalRoute::Sm89NnN96V1
        | Tf32PhysicalRoute::Sm89NtALdmatrixN96V1 => availability.joint,
