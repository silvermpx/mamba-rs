...
use crate::mamba3_siso::gpu::state::{GpuMamba3Dims, GpuMamba3Scratch};
use crate::mamba3_siso::gpu::training_graph::GpuMamba3TrainingStepGraph;
...
impl Mamba3Trainer {
    ...
    pub fn new_full(
        ...
        assert!(
            ...
            "Mamba3Trainer currently supports bf16 only"
        );
