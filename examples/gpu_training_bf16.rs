//! Mamba-1 bf16 mixed-precision training with CUDA Graph capture.
//!
//! ```bash
//! cargo run --release --example gpu_training_bf16 --features cuda
//! ```
//!
//! Runs a short synthetic training loop using [`MambaTrainer`], exercising
//! every piece of the v0.2.2 training stack: bf16 master→compute shadow,
//! f32 master AdamW, CUDA Graph capture of the full training step, and
