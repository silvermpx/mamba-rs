...
routes with the 0.7.1 records of the same cells on the same board. The
same cells timed by the final 0.7.3 tree on the other boards, against
cuBLAS on each board, are on the [RTX 5090](gemm-benchmarks-0.7.3-rtx5090.md),
[A100](gemm-benchmarks-0.7.3-a100.md) and [H100](gemm-benchmarks-0.7.3-h100.md)
pages.
...
Kernel names on this page are spelled as the tree spells them today; the
renaming carried no kernel change. Two rows name a kernel this tree no
longer composes - the d128 weight gradients `tn_sm89_f32_d128_in_m16n16_f64fold`
and `tn_sm89_f32_d128_out_m8n16_f64fold`, which the unreleased wave
replaced with faster routes of the same bits. Their numbers stand as the
measurement of the kernel that ran then; the routes that replaced them and
what they measure are in [CHANGELOG.md](../CHANGELOG.md).
...
|---|:--:|---|---:|---:|---:|---:|---:|---:|
| 4621 × 384 × 1928 | off | `nn_sm89_tc128_pipeline_bf16` | 64.16 | 74.90 | 1.167× | 63.75 | 74.53 | 1.169× |
| 4621 × 384 × 1928 | on | `nn_sm89_tc128_pipeline_bf16` | 65.40 | 108.67 | 1.662× | 65.00 | 107.96 | 1.661× |
| 4621 × 768 × 2304 | off | `nn_sm89_tc128_s3_bf16` | 126.12 | 103.83 | 0.822× | 126.22 | 103.48 | 0.821× |
| 4621 × 768 × 2304 | on | `nn_sm89_tc128_swizzle_bf16` | 123.08 | 124.51 | 1.012× | 123.50 | 124.34 | 1.007× |
| 4621 × 1928 × 384 | off | `nn_sm89_tc128_pipeline_bf16` | 54.05 | 74.69 | 1.382× | 53.88 | 75.01 | 1.393× |
| 4621 × 1928 × 384 | on | `nn_sm89_tc128_pipeline_bf16` | 54.35 | 84.10 | 1.547× | 54.32 | 85.60 | 1.576× |
| 2048 × 768 × 2304 | off | `nn_sm89_tc128_swizzle_bf16` | 65.62 | 60.40 | 0.921× | 65.06 | 59.12 | 0.909× |
| 2048 × 768 × 2304 | on | `nn_sm89_tc128_swizzle_bf16` | 66.41 | 80.15 | 1.207× | 65.67 | 78.66 | 1.198× |
| 2048 × 2304 × 768 | off | `nn_sm89_tc128_swizzle_bf16` | 60.61 | 68.76 | 1.135× | 60.58 | 68.69 | 1.134× |
| 2048 × 2304 × 768 | on | `nn_sm89_tc128_swizzle_bf16` | 60.87 | 77.46 | 1.273× | 60.70 | 76.38 | 1.259× |
...
| M × K × N | bias | mamba-rs kernel | mamba-rs eager µs | cuBLAS eager µs | eager speedup | mamba-rs graph µs | cuBLAS graph µs | graph speedup |
|---|:--:|---|---:|---:|---:|---:|---:|---:|
| 4621 × 384 × 1928 | off | `nn_sm89_tc128_pipeline_f16` | 66.83 | 75.20 | 1.125× | 66.97 | 75.02 | 1.120× |
| 4621 × 384 × 1928 | on | `nn_sm89_tc128_pipeline_f16` | 65.40 | 108.35 | 1.657× | 65.00 | 107.60 | 1.655× |
| 4621 × 768 × 2304 | off | `nn_sm89_tc128_s3_f16` | 139.02 | 119.87 | 0.862× | 138.79 | 119.30 | 0.861× |
| 4621 × 768 × 2304 | on | `nn_sm89_tc128_swizzle_f16` | 134.47 | 140.97 | 1.048× | 135.34 | 140.13 | 1.040× |
| 4621 × 1928 × 384 | off | `nn_sm89_tc128_pipeline_f16` | 56.88 | 75.93 | 1.335× | 57.22 | 76.64 | 1.343× |
| 4621 × 1928 × 384 | on | `nn_sm89_tc128_pipeline_f16` | 54.97 | 84.28 | 1.536× | 54.57 | 85.38 | 1.565× |
| 2048 × 768 × 2304 | off | `nn_sm89_m64n64_bk64_s3_f16` | 72.14 | 70.96 | 0.979× | 73.02 | 70.47 | 0.966× |
| 2048 × 768 × 2304 | on | `nn_sm89_tc128_swizzle_f16` | 66.41 | 80.20 | 1.208× | 65.64 | 78.64 | 1.198× |
| 2048 × 2304 × 768 | off | `nn_sm89_m128n64_bk64_s2_f16` | 60.70 | 62.38 | 1.028× | 60.54 | 62.19 | 1.027× |
| 2048 × 2304 × 768 | on | `nn_sm89_tc128_pipeline_f16` | 61.88 | 69.23 | 1.119× | 61.72 | 68.51 | 1.110× |
...
| M × K × N | bias | mamba-rs kernel | mamba-rs eager µs | cuBLAS eager µs | eager speedup | mamba-rs graph µs | cuBLAS graph µs | graph speedup |
|---|:--:|---|---:|---:|---:|---:|---:|---:|
| 4621 × 384 × 1928 | off | `nn_rna_wide_tf32_m128n128_bk32_s3` | 111.40 | 103.00 | 0.924× | 110.41 | 102.59 | 0.929× |
| 4621 × 384 × 1928 | on | `nn_rna_wide_tf32_m128n128_bk32_s3` | 113.87 | 131.21 | 1.152× | 113.18 | 130.13 | 1.150× |
| 4621 × 768 × 2304 | off | `nn_rna_wide_tf32_m128n128_bk32_s3` | 234.10 | 213.24 | 0.911× | 234.39 | 214.11 | 0.913× |
| 4621 × 768 × 2304 | on | `nn_rna_wide_tf32_m128n128_bk32_s3` | 234.87 | 245.60 | 1.045× | 234.70 | 244.20 | 1.046× |
| 4621 × 1928 × 384 | off | `nn_rna_wide_tf32_m128n128_bk32_s3` | 106.42 | 81.14 | 0.762× | 107.86 | 82.09 | 0.761× |
| 4621 × 1928 × 384 | on | `nn_rna_wide_tf32_m128n128_bk32_s3` | 105.18 | 88.12 | 0.838× | 105.74 | 87.87 | 0.831× |
| 2048 × 768 × 2304 | off | `nn_rna_wide_tf32_m128n128_bk32_s3` | 125.39 | 99.37 | 0.793× | 123.15 | 98.75 | 0.802× |
| 2048 × 768 × 2304 | on | `nn_rna_wide_tf32_m128n128_bk32_s3` | 126.69 | 116.37 | 0.919× | 125.14 | 114.92 | 0.918× |
| 2048 × 2304 × 768 | off | `nn_sm89_rna_tf32_m128n96_bk32_s3` | 106.62 | 95.75 | 0.898× | 108.13 | 97.02 | 0.897× |
| 2048 × 2304 × 768 | on | `nn_rna_wide_tf32_m128n128_bk32_s3` | 119.56 | 98.74 | 0.826× | 119.18 | 97.79 | 0.821× |
...
| M × K × N | bias | mamba-rs kernel | mamba-rs eager µs | cuBLAS eager µs | eager speedup | mamba-rs graph µs | cuBLAS graph µs | graph speedup |
|---|:--:|---|---:|---:|---:|---:|---:|---:|
| 4621 × 384 × 1928 | off | `nn_sm89_f32_n64_copyplan` | 285.58 | 315.33 | 1.105× | 288.87 | 318.85 | 1.104× |
| 4621 × 384 × 1928 | on | `nn_sm89_f32_n64_copyplan` | 265.95 | 321.67 | 1.210× | 268.59 | 324.39 | 1.208× |
| 4621 × 768 × 2304 | off | `nn_sm89_f32_n64_copyplan` | 744.74 | 755.57 | 1.015× | 747.08 | 755.42 | 1.013× |
| 4621 × 768 × 2304 | on | `nn_sm89_f32_n64_copyplan` | 686.55 | 734.79 | 1.070× | 686.52 | 732.89 | 1.068× |
...
| 2048 × 768 × 2304 | off | `nn_sm89_f32_n64_copyplan` | 232.40 | 278.85 | 1.191× | 233.98 | 278.15 | 1.188× |
| 2048 × 768 × 2304 | on | `nn_sm89_f32_n64_copyplan` | 233.04 | 293.55 | 1.259× | 234.73 | 295.19 | 1.257× |
| 2048 × 2304 × 768 | off | `nn_sm89_f32_n64_copyplan` | 284.44 | 287.29 | 1.011× | 300.43 | 304.30 | 1.008× |
| 2048 × 2304 × 768 | on | `nn_sm89_f32_n64_copyplan` | 281.83 | 292.14 | 1.036× | 298.78 | 308.52 | 1.033× |
...
| M × K × N | bias | mamba-rs kernel | mamba-rs eager µs | cuBLAS eager µs | eager speedup | mamba-rs graph µs | cuBLAS graph µs | graph speedup |
|---|:--:|---|---:|---:|---:|---:|---:|---:|
| 4621 × 384 × 1928 | off | `nn_sm89_f32_n64_copyplan` | 234.06 | 128.59 | 0.549× | 226.94 | 122.38 | 0.547× |
| 4621 × 384 × 1928 | on | `nn_sm89_f32_n64_copyplan` | 225.97 | 151.88 | 0.670× | 228.78 | 151.55 | 0.667× |
| 4621 × 768 × 2304 | off | `nn_sm89_f32_n64_copyplan` | 567.17 | 256.00 | 0.451× | 560.77 | 251.85 | 0.450× |
| 4621 × 768 × 2304 | on | `nn_sm89_f32_n64_copyplan` | 557.29 | 287.99 | 0.517× | 557.18 | 286.78 | 0.514× |
...
| 2048 × 768 × 2304 | off | `nn_sm89_f32_n64_copyplan` | 236.35 | 115.98 | 0.491× | 238.31 | 115.98 | 0.486× |
| 2048 × 768 × 2304 | on | `nn_sm89_f32_n64_copyplan` | 232.93 | 131.49 | 0.565× | 232.59 | 130.10 | 0.559× |
| 2048 × 2304 × 768 | off | `nn_sm89_f32_n64_copyplan` | 238.93 | 108.50 | 0.454× | 243.27 | 110.01 | 0.453× |
| 2048 × 2304 × 768 | on | `nn_sm89_f32_n64_copyplan` | 237.35 | 115.46 | 0.486× | 237.21 | 114.47 | 0.483× |
...
| M × K × N | bias | mamba-rs kernel | mamba-rs eager µs | cuBLAS eager µs | eager speedup | mamba-rs graph µs | cuBLAS graph µs | graph speedup |
|---|:--:|---|---:|---:|---:|---:|---:|---:|
| 4621 × 384 × 1928 | off | `nn_sm120_tma_tf32_m128n64_bk32_s2` | 71.95 | 80.97 | 1.125× | 73.62 | 81.95 | 1.113× |
| 4621 × 384 × 1928 | on | `nn_sm120_tma_tf32_m128n64_bk32_s2` | 72.02 | 100.20 | 1.391× | 73.68 | 100.46 | 1.365× |
| 4621 × 768 × 2304 | off | `nn_sm120_tma_tf32_m128n64_bk32_s2` | 160.85 | 153.09 | 0.956× | 160.98 | 153.72 | 0.958× |
| 4621 × 768 × 2304 | on | `nn_sm120_tma_tf32_m128n64_bk32_s2` | 160.02 | 177.64 | 1.110× | 160.25 | 178.30 | 1.115× |
| 4621 × 1928 × 384 | off | `nn_sm120_tma_tf32_m64n64_bk32_s2` | 79.40 | 89.80 | 1.131× | 80.05 | 90.18 | 1.127× |
| 4621 × 1928 × 384 | on | `nn_sm120_tma_tf32_m64n64_bk32_s2` | 79.54 | 94.95 | 1.194× | 80.21 | 96.25 | 1.200× |
| 2048 × 768 × 2304 | off | `nn_sm120_tma_tf32_m64n64_bk32_s2_pair_store` | 75.63 | 75.25 | 0.995× | 76.41 | 75.83 | 0.993× |
| 2048 × 768 × 2304 | on | `nn_sm120_tma_tf32_m64n64_bk32_s2_pair_store` | 75.79 | 85.78 | 1.132× | 76.66 | 86.08 | 1.124× |
| 2048 × 2304 × 768 | off | `nn_sm120_tma_tf32_m64n64_bk32_s2` | 92.17 | 105.39 | 1.144× | 93.74 | 106.52 | 1.136× |
| 2048 × 2304 × 768 | on | `nn_sm120_tma_tf32_m64n64_bk32_s2` | 92.65 | 110.70 | 1.195× | 94.20 | 110.90 | 1.177× |
...
| M × K × N | bias | mamba-rs kernel | mamba-rs eager µs | cuBLAS eager µs | eager speedup | mamba-rs graph µs | cuBLAS graph µs | graph speedup |
|---|:--:|---|---:|---:|---:|---:|---:|---:|
| 4621 × 384 × 1928 | off | `nn_sm120_tma_fma_m64n128_bk16_s2` | 113.83 | 139.17 | 1.221× | 114.04 | 133.24 | 1.170× |
| 4621 × 384 × 1928 | on | `nn_sm120_tma_fma_postbias_m128n64_t256_bk16_s2` | 114.71 | 157.70 | 1.376× | 116.30 | 157.97 | 1.375× |
| 4621 × 768 × 2304 | off | `nn_sm120_tma_fma_m128n64_bk16_s2` | 267.00 | 306.15 | 1.146× | 257.32 | 291.88 | 1.135× |
| 4621 × 768 × 2304 | on | `nn_sm120_tma_fma_postbias_m128n64_bk16_s2` | 266.70 | 324.53 | 1.213× | 260.54 | 316.63 | 1.207× |
| 4621 × 1928 × 384 | off | `f32_f32_s2` | 150.07 | 128.29 | 0.857× | 150.51 | 127.25 | 0.845× |
| 4621 × 1928 × 384 | on | `nn_sm120_tma_fma_postbias_m128n96_bk16_s2` | 144.55 | 129.68 | 0.895× | 145.03 | 129.41 | 0.893× |
| 2048 × 768 × 2304 | off | `nn_sm120_f32_n64_copyplan` | 114.65 | 125.37 | 1.126× | 121.69 | 137.41 | 1.122× |
| 2048 × 768 × 2304 | on | `nn_sm120_f32_n64_copyplan` | 120.13 | 149.21 | 1.239× | 119.83 | 148.37 | 1.237× |
| 2048 × 2304 × 768 | off | `nn_sm120_f32_n64_copyplan` | 136.03 | 125.23 | 0.921× | 137.26 | 125.15 | 0.912× |
| 2048 × 2304 × 768 | on | `nn_sm120_f32_n64_copyplan` | 136.57 | 131.49 | 0.965× | 137.26 | 132.84 | 0.968× |
...
| M × K × N | bias | mamba-rs kernel | mamba-rs eager µs | cuBLAS eager µs | eager speedup | mamba-rs graph µs | cuBLAS graph µs | graph speedup |
|---|:--:|---|---:|---:|---:|---:|---:|---:|
| 4621 × 384 × 1928 | off | `nn_sm120_tma_fma_m64n128_bk16_s2` | 109.71 | 81.25 | 0.743× | 110.22 | 82.01 | 0.744× |
| 4621 × 384 × 1928 | on | `nn_sm120_tma_fma_postbias_m128n64_t256_bk16_s2` | 111.97 | 100.41 | 0.897× | 112.59 | 101.47 | 0.901× |
| 4621 × 768 × 2304 | off | `nn_sm120_tma_fma_m128n64_bk16_s2` | 225.58 | 162.73 | 0.716× | 225.85 | 167.94 | 0.744× |
| 4621 × 768 × 2304 | on | `nn_sm120_tma_fma_postbias_m128n64_bk16_s2` | 230.43 | 195.27 | 0.842× | 230.57 | 192.72 | 0.836× |
| 4621 × 1928 × 384 | off | `f32_f32_s2` | 132.84 | 90.01 | 0.678× | 133.54 | 90.87 | 0.681× |
| 4621 × 1928 × 384 | on | `nn_sm120_tma_fma_postbias_m128n96_bk16_s2` | 128.26 | 95.65 | 0.743× | 129.07 | 96.27 | 0.746× |
| 2048 × 768 × 2304 | off | `nn_sm120_f32_n64_copyplan` | 111.01 | 76.03 | 0.683× | 112.49 | 77.91 | 0.693× |
| 2048 × 768 × 2304 | on | `nn_sm120_f32_n64_copyplan` | 111.45 | 87.15 | 0.783× | 112.30 | 86.81 | 0.782× |
| 2048 × 2304 × 768 | off | `nn_sm120_f32_n64_copyplan` | 129.75 | 105.99 | 0.817× | 130.99 | 106.56 | 0.814× |
| 2048 × 2304 × 768 | on | `nn_sm120_f32_n64_copyplan` | 129.80 | 110.83 | 0.854× | 131.00 | 111.75 | 0.853× |
...
| d768 in_proj | NN | 2048 × 768 × 3072 | `nn_sm89_m128n128_bk64_s3_bf16` | 62.244 | 78.193 | 1.256× | 61.786 | 77.320 | 1.251× |
| d768 in_proj | NT | 2048 × 768 × 3072 | `nt_sm89_m128n128_bk64_s3_bxor_bf16` | 70.934 | 76.491 | 1.078× | 70.641 | 75.896 | 1.074× |
| d768 in_proj | TN | 2048 × 768 × 3072 | `tn_sm89_m64n64_bk64_s2_regpipe_vec2_bf16` | 86.937 | 90.478 | 1.041× | 86.599 | 87.164 | 1.007× |
| d768 out_proj | NN | 2048 × 1536 × 768 | `nn_sm89_m128n128_bk64_s3_bf16` | 37.936 | 46.993 | 1.239× | 37.729 | 46.738 | 1.239× |
| d768 out_proj | NT | 2048 × 1536 × 768 | `nt_sm89_m96n128_bk64_s3_bf16` | 36.589 | 37.906 | 1.036× | 36.250 | 38.132 | 1.052× |
| d768 out_proj | TN | 2048 × 1536 × 768 | `tn_sm89_m64n64_bk64_s2_regpipe_vec2_bf16` | 55.178 | 50.797 | 0.921× | 55.159 | 49.418 | 0.896× |
| classifier page in_proj | NN | 4621 × 384 × 1928 | `nn_sm89_m128n128_bk64_s3_bf16` | 59.667 | 73.473 | 1.231× | 59.114 | 73.045 | 1.236× |
| classifier page in_proj | NT | 4621 × 384 × 1928 | `nt_sm89_m128n128_bk64_s3_bxor_bf16` | 48.645 | 61.848 | 1.271× | 48.668 | 61.128 | 1.256× |
| classifier page in_proj | TN | 4621 × 384 × 1928 | `tn_sm89_m64n64_bk64_s2_compact_bxor_bf16` | 77.557 | 55.133 | 0.711× | 77.039 | 53.863 | 0.699× |
...
| d768 in_proj | NN | 2048 × 768 × 3072 | `nn_sm89_m128n128_bk64_s3_f16` | 62.230 | 59.152 | 0.951× | 61.798 | 58.603 | 0.948× |
| d768 in_proj | NT | 2048 × 768 × 3072 | `nt_sm89_m128n128_bk64_s3_bxor_f16` | 71.057 | 70.400 | 0.991× | 70.788 | 71.017 | 1.003× |
| d768 in_proj | TN | 2048 × 768 × 3072 | `tn_sm89_m64n64_bk64_s2_regpipe_vec2_f16` | 86.842 | 90.590 | 1.043× | 86.705 | 86.877 | 1.002× |
| d768 out_proj | NN | 2048 × 1536 × 768 | `nn_sm89_m128n128_bk64_s3_f16` | 38.020 | 46.623 | 1.226× | 37.754 | 46.345 | 1.228× |
| d768 out_proj | NT | 2048 × 1536 × 768 | `nt_sm89_m96n128_bk64_s3_f16` | 36.590 | 39.022 | 1.066× | 36.260 | 39.201 | 1.081× |
| d768 out_proj | TN | 2048 × 1536 × 768 | `tn_sm89_m64n64_bk64_s2_compact_bxor_f16` | 56.061 | 50.679 | 0.904× | 56.134 | 49.480 | 0.881× |
| classifier page in_proj | NN | 4621 × 384 × 1928 | `nn_sm89_m128n128_bk64_s3_f16` | 59.792 | 73.232 | 1.225× | 59.209 | 72.747 | 1.229× |
| classifier page in_proj | NT | 4621 × 384 × 1928 | `nt_sm89_m128n128_bk64_s3_bxor_f16` | 48.666 | 96.380 | 1.980× | 48.676 | 95.174 | 1.955× |
| classifier page in_proj | TN | 4621 × 384 × 1928 | `tn_sm89_m64n64_bk64_s2_compact_bxor_f16` | 77.675 | 55.082 | 0.709× | 77.019 | 53.872 | 0.699× |
...
| shape | op | M × K × N | mamba-rs kernel chain | mamba-rs eager µs | cuBLAS eager µs | eager speedup | mamba-rs graph µs | cuBLAS graph µs | graph speedup |
|---|:--:|---|---|---:|---:|---:|---:|---:|---:|
| underfill | NN | 256 × 512 × 384 | `nn_sm80_mma_tf32_splitk2_m16n32_bk32_s4` | 11.165 | 10.040 | 0.899× | 10.743 | 9.761 | 0.909× |
| underfill | NT | 256 × 512 × 384 | `nt_sm80_mma_tf32_m16n32_bk32_s4` | 10.130 | 7.998 | 0.789× | 10.131 | 7.682 | 0.758× |
| underfill | TN | 256 × 512 × 384 | `tn_sm80_mma_tf32_m16n32_bk32_s4` | 10.471 | 7.828 | 0.748× | 10.267 | 7.838 | 0.763× |
| d128 in_proj | NN | 1024 × 128 × 512 | `nn_sm80_mma_tf32_m64n64_bk32_s2` | 9.944 | 5.673 | 0.570× | 9.740 | 5.512 | 0.566× |
| d128 in_proj | NT | 1024 × 128 × 512 | `nt_sm80_mma_tf32_splitk4_m16n32_bk32_s3` | 12.166 | 9.427 | 0.775× | 11.902 | 9.087 | 0.763× |
| d128 in_proj | TN | 1024 × 128 × 512 | `tn_sm80_mma_tf32_splitk8_m32n32_bk32_s4` | 16.634 | 10.112 | 0.608× | 16.458 | 9.358 | 0.569× |
| d128 out_proj | NN | 1024 × 256 × 128 | `nn_sm80_mma_tf32_m16n32_bk32_s4` | 7.652 | 6.805 | 0.889× | 7.575 | 6.573 | 0.868× |
| d128 out_proj | NT | 1024 × 256 × 128 | `nt_sm80_mma_tf32_m16n32_bk32_s4` | 7.901 | 5.147 | 0.651× | 7.826 | 4.961 | 0.634× |
| d128 out_proj | TN | 1024 × 256 × 128 | `tn_sm80_mma_tf32_splitk8_m32n32_bk32_s3` | 10.219 | 9.845 | 0.963× | 9.954 | 8.973 | 0.901× |
| d768 in_proj | NN | 2048 × 768 × 3072 | `nn_sm80_mma_tf32_m128n128_bk32_s3` | 123.648 | 101.675 | 0.822× | 121.906 | 100.818 | 0.827× |
| d768 in_proj | NT | 2048 × 768 × 3072 | `nt_sm89_tf32_a_ldmatrix_m128n96_bk32_s3` | 115.331 | 117.147 | 1.016× | 114.874 | 116.736 | 1.016× |
| d768 in_proj | TN | 2048 × 768 × 3072 | `tn_sm89_tf32_pre_rna_transpose_32x32 + tn_sm89_tf32_pre_rna_m64n96_bk32_s2` | 159.579 | 134.572 | 0.843× | 157.760 | 132.045 | 0.837× |
| d768 out_proj | NN | 2048 × 1536 × 768 | `nn_sm89_tf32_addhalf_m128n96_bk32_s3` | 63.687 | 62.922 | 0.988× | 63.343 | 62.553 | 0.988× |
| d768 out_proj | NT | 2048 × 1536 × 768 | `nt_sm89_tf32_a_ldmatrix_m128n96_bk32_s3` | 64.990 | 66.788 | 1.028× | 63.314 | 66.253 | 1.046× |
| d768 out_proj | TN | 2048 × 1536 × 768 | `tn_sm89_tf32_pre_rna_transpose_32x32 + tn_sm89_tf32_pre_rna_m128n96_bk32_s3` | 94.073 | 82.567 | 0.878× | 93.484 | 82.304 | 0.880× |
| large deep | NN | 4096 × 3072 × 1536 | `nn_sm80_mma_tf32_m128n128_bk32_s3` | 481.621 | 383.195 | 0.796× | 484.523 | 383.706 | 0.792× |
| large deep | NT | 4096 × 3072 × 1536 | `nt_sm89_tf32_a_ldmatrix_m128n96_bk32_s3` | 526.988 | 408.430 | 0.775× | 530.153 | 411.282 | 0.776× |
| large deep | TN | 4096 × 3072 × 1536 | `tn_sm89_tf32_pre_rna_transpose_32x32 + tn_sm89_tf32_pre_rna_m128n96_bk32_s3` | 601.796 | 474.988 | 0.789× | 600.064 | 470.935 | 0.785× |
| classifier page in_proj | NN | 4621 × 384 × 1928 | `nn_sm89_tf32_addhalf_m128n96_bk32_s3_direct` | 104.189 | 103.119 | 0.990× | 102.439 | 102.730 | 1.003× |
| classifier page in_proj | NT | 4621 × 384 × 1928 | `nt_sm89_mma_tf32_compact8_m128n64_bk32_s2` | 144.647 | 76.980 | 0.532× | 144.383 | 76.610 | 0.531× |
| classifier page in_proj | TN | 4621 × 384 × 1928 | `tn_sm89_tf32_pre_rna_transpose_32x32 + tn_sm89_tf32_pre_rna_m64n96_bk32_s2` | 140.514 | 100.260 | 0.714× | 139.209 | 99.341 | 0.714× |
...
| d128 in_proj | TN | 1024 × 128 × 512 | `tn_sm89_f32_d128_in_m16n16_f64fold` | 35.239 | 10.104 | 0.287× | 35.273 | 9.345 | 0.265× |
...
| d128 out_proj | TN | 1024 × 256 × 128 | `tn_sm89_f32_d128_out_m8n16_f64fold` | 27.506 | 9.777 | 0.355× | 27.546 | 8.945 | 0.325× |
| d768 in_proj | NN | 2048 × 768 × 3072 | `nn_sm89_f32_n64_copyplan` | 283.989 | 116.395 | 0.410× | 284.139 | 116.019 | 0.408× |
| d768 in_proj | NT | 2048 × 768 × 3072 | `transpose_f32_32x16_d768 + nn_sm89_f32_n64_copyplan` | 274.701 | 118.223 | 0.430× | 276.103 | 119.498 | 0.433× |
| d768 in_proj | TN | 2048 × 768 × 3072 | `transpose_f32_32x16_d768 + tn_sm89_f32_n64_dual_chunk_fused_finalize` | 309.489 | 134.112 | 0.433× | 307.863 | 131.994 | 0.429× |
| d768 out_proj | NN | 2048 × 1536 × 768 | `nn_sm89_f32_n64_copyplan` | 135.002 | 63.501 | 0.470× | 134.393 | 62.579 | 0.466× |
| d768 out_proj | NT | 2048 × 1536 × 768 | `transpose_f32_32x16_d768 + nn_sm89_f32_n64_copyplan` | 139.802 | 66.842 | 0.478× | 138.894 | 66.331 | 0.478× |
| d768 out_proj | TN | 2048 × 1536 × 768 | `tn_sm89_f32_m64n64_bk16_s2_d768_out_raw + splitm_reduce` | 188.749 | 82.572 | 0.437× | 187.961 | 82.300 | 0.438× |
| classifier page in_proj | NN | 4621 × 384 × 1928 | `nn_sm89_f32_n64_copyplan` | 198.805 | 110.416 | 0.555× | 194.999 | 109.025 | 0.559× |
| classifier page in_proj | NT | 4621 × 384 × 1928 | `transpose_f32_32x16_d768 + nn_sm89_f32_n64_copyplan` | 298.965 | 76.982 | 0.257× | 297.984 | 76.614 | 0.257× |
| classifier page in_proj | TN | 4621 × 384 × 1928 | `tn_sm89_f32_m64n64_bk16_s2_prism_raw + splitm_reduce` | 235.082 | 100.295 | 0.427× | 234.095 | 99.354 | 0.424× |
...
| d128 in_proj | TN | 1024 × 128 × 512 | `tn_sm89_f32_d128_in_m16n16_f64fold` | 35.239 | 12.706 | 0.361× | 35.279 | 11.309 | 0.321× |
...
| d128 out_proj | TN | 1024 × 256 × 128 | `tn_sm89_f32_d128_out_m8n16_f64fold` | 27.508 | 10.556 | 0.384× | 27.540 | 9.830 | 0.357× |
| d768 in_proj | NN | 2048 × 768 × 3072 | `nn_sm89_f32_n64_copyplan` | 268.434 | 323.885 | 1.207× | 268.337 | 322.921 | 1.203× |
| d768 in_proj | NT | 2048 × 768 × 3072 | `transpose_f32_32x16_d768 + nn_sm89_f32_n64_copyplan` | 349.553 | 346.565 | 0.991× | 348.537 | 345.721 | 0.992× |
| d768 in_proj | TN | 2048 × 768 × 3072 | `transpose_f32_32x16_d768 + tn_sm89_f32_n64_dual_chunk_fused_finalize` | 309.301 | 268.835 | 0.869× | 308.043 | 267.033 | 0.867× |
| d768 out_proj | NN | 2048 × 1536 × 768 | `nn_sm89_f32_n64_copyplan` | 162.621 | 168.199 | 1.034× | 162.429 | 167.587 | 1.032× |
| d768 out_proj | NT | 2048 × 1536 × 768 | `transpose_f32_32x16_d768 + nn_sm89_f32_n64_copyplan` | 169.351 | 175.037 | 1.034× | 169.899 | 175.496 | 1.033× |
| d768 out_proj | TN | 2048 × 1536 × 768 | `tn_sm89_f32_m64n64_bk16_s2_d768_out_raw + splitm_reduce` | 188.757 | 134.256 | 0.711× | 187.961 | 133.635 | 0.711× |
| classifier page in_proj | NN | 4621 × 384 × 1928 | `nn_sm89_f32_n64_copyplan` | 248.301 | 276.005 | 1.112× | 251.502 | 278.656 | 1.108× |
| classifier page in_proj | NT | 4621 × 384 × 1928 | `transpose_f32_32x16_d768 + nn_sm89_f32_n64_copyplan` | 298.963 | 243.517 | 0.815× | 297.978 | 242.639 | 0.814× |
| classifier page in_proj | TN | 4621 × 384 × 1928 | `tn_sm89_f32_m64n64_bk16_s2_prism_raw + splitm_reduce` | 235.085 | 189.318 | 0.805× | 234.089 | 187.740 | 0.802× |
...
| underfill | TN | 256 × 512 × 384 | `tn_sm80_mma_tf32_m16n32_bk32_s4` | 6.298 | 6.804 | 1.080× | 8.202 | 6.150 | 0.750× ‡ |
| d128 in_proj | NN | 1024 × 128 × 512 | `nn_sm80_mma_tf32_m64n64_bk32_s3` | 5.470 | 11.186 | 2.045× | 6.150 | 4.099 | 0.666× ‡ |
| d128 in_proj | NT | 1024 × 128 × 512 | `nt_sm80_mma_tf32_m16n16_bk32_s4` | 7.571 | 11.076 | 1.463× | 8.201 | 8.199 | 1.000× ‡ |
| d128 in_proj | TN | 1024 × 128 × 512 | `tn_sm80_mma_tf32_m16n32_bk32_s4` | 9.645 | 10.472 | 1.086× | 10.253 | 8.193 | 0.799× ‡ |
| d128 out_proj | NN | 1024 × 256 × 128 | `nn_splitk32_partial + splitk_reduce` | 7.186 | 10.200 | 1.419× | 6.148 | 6.145 | 0.999× ‡ |
| d128 out_proj | NT | 1024 × 256 × 128 | `transpose_f32_32x16_d768 + nn_m64n64_bk16_s2` | 9.310 | 10.081 | 1.083× | 8.192 | 4.099 | 0.500× ‡ |
| d128 out_proj | TN | 1024 × 256 × 128 | `tn_sm80_mma_tf32_m16n16_bk32_s4` | 9.307 | 10.369 | 1.114× | 10.253 | 8.192 | 0.799× ‡ |
| d768 in_proj | NN | 2048 × 768 × 3072 | `nn_sm120_tma_mma_tf32_m64n128_bk32_s2` | 102.957 | 114.765 | 1.115× | 104.655 | 116.251 | 1.111× |
| d768 in_proj | NT | 2048 × 768 × 3072 | `nt_sm120_tma_mma_tf32_m64n64_bk32_s2` | 128.398 | 140.306 | 1.093× | 129.274 | 141.354 | 1.093× |
| d768 in_proj | TN | 2048 × 768 × 3072 | `tn_sm120_tma_mma_tf32_m64n128_bk32_s3_pair_streamk` | 98.248 | 97.667 | 0.994× | 99.032 | 98.603 | 0.996× |
| d768 out_proj | NN | 2048 × 1536 × 768 | `nn_sm120_tma_mma_tf32_m64n64_bk32_s2` | 66.642 | 71.747 | 1.077× | 67.679 | 73.719 | 1.089× |
| d768 out_proj | NT | 2048 × 1536 × 768 | `nt_sm120_tma_mma_tf32_m64n64_bk32_s2` | 54.536 | 76.026 | 1.394× | 55.582 | 77.817 | 1.400× |
| d768 out_proj | TN | 2048 × 1536 × 768 | `tn_sm120_tma_mma_tf32_m64n128_bk32_s3_pair_streamk` | 54.328 | 50.779 | 0.935× | 55.600 | 51.454 | 0.925× |
| large deep | NN | 4096 × 3072 × 1536 | `nn_sm120_tma_mma_tf32_m64n128_bk32_s2` | 391.879 | 430.200 | 1.098× | 390.090 | 427.443 | 1.096× |
| large deep | NT | 4096 × 3072 × 1536 | `nt_sm120_tma_mma_tf32_m64n128_bk32_s2` | 391.808 | 369.392 | 0.943× | 395.328 | 371.659 | 0.940× |
| large deep | TN | 4096 × 3072 × 1536 | `tn_sm120_tma_mma_tf32_m64n128_bk32_s3_pair_streamk` | 368.978 | 377.173 | 1.022× | 368.775 | 373.406 | 1.013× |
| classifier page in_proj | NN | 4621 × 384 × 1928 | `nn_sm120_tma_mma_tf32_m64n64_bk32_s2` | 78.861 | 81.441 | 1.033× | 79.989 | 82.025 | 1.025× |
| classifier page in_proj | NT | 4621 × 384 × 1928 | `nt_sm120_tma_mma_tf32_m64n64_bk32_s2` | 81.865 | 90.035 | 1.100× | 83.686 | 90.547 | 1.082× |
| classifier page in_proj | TN | 4621 × 384 × 1928 | `tn_sm120_tma_mma_tf32_m64n128_bk32_s3_pair_streamk` | 75.974 | 79.184 | 1.042× | 76.587 | 80.170 | 1.047× |
...
| d128 out_proj | NT | 1024 × 256 × 128 | `transpose_f32_32x16_d768 + nn_m64n64_bk16_s2` | 8.935 | 10.049 | 1.125× | 8.191 | 4.099 | 0.500× ‡ |
| d128 out_proj | TN | 1024 × 256 × 128 | `tn_splitm_partial_aligned + splitm_reduce` | 15.025 | 10.496 | 0.699× | 16.396 | 8.192 | 0.500× ‡ |
| d768 in_proj | NN | 2048 × 768 × 3072 | `nn_sm120_tma_fma_m128n64_bk16_s2` | 137.751 | 116.700 | 0.847× | 140.353 | 120.817 | 0.861× |
| d768 in_proj | NT | 2048 × 768 × 3072 | `nt_sm120_tma_fma_m128n64_bk16_s2_kvec` | 150.992 | 140.689 | 0.932× | 152.037 | 142.143 | 0.935× |
| d768 in_proj | TN | 2048 × 768 × 3072 | `tn_sm120_tma_fma_m64n128_bk16_s2` | 140.884 | 97.949 | 0.695× | 141.256 | 98.653 | 0.698× |
| d768 out_proj | NN | 2048 × 1536 × 768 | `nn_sm120_tma_fma_m128n64_bk16_s2` | 80.975 | 71.681 | 0.885× | 82.121 | 73.719 | 0.898× |
| d768 out_proj | NT | 2048 × 1536 × 768 | `nt_sm120_tma_fma_m64n128_bk16_s2` | 82.033 | 76.027 | 0.927× | 82.928 | 77.818 | 0.938× |
| d768 out_proj | TN | 2048 × 1536 × 768 | `tn_sm120_tma_fma_m128n64_bk16_s2` | 76.106 | 50.621 | 0.665× | 76.555 | 51.440 | 0.672× |
| classifier page in_proj | NN | 4621 × 384 × 1928 | `nn_sm120_tma_fma_m64n128_bk16_s2` | 111.464 | 82.119 | 0.737× | 112.573 | 83.724 | 0.744× |
| classifier page in_proj | NT | 4621 × 384 × 1928 | `nt_sm120_tma_fma_m128n64_bk16_s2_kvec` | 106.038 | 90.865 | 0.857× | 106.900 | 90.284 | 0.845× |
| classifier page in_proj | TN | 4621 × 384 × 1928 | `tn_sm120_tma_fma_m128n64_bk16_s2` | 102.777 | 79.203 | 0.771× | 103.590 | 80.168 | 0.774× |
...
| d128 out_proj | NT | 1024 × 256 × 128 | `transpose_f32_32x16_d768 + nn_m64n64_bk16_s2` | 9.143 | 9.723 | 1.063× | 8.192 | 8.193 | 1.000× ‡ |
| d128 out_proj | TN | 1024 × 256 × 128 | `tn_splitm_partial_aligned + splitm_reduce` | 15.033 | 10.387 | 0.691× | 16.394 | 6.149 | 0.375× ‡ |
| d768 in_proj | NN | 2048 × 768 × 3072 | `nn_sm120_tma_fma_m128n64_bk16_s2` | 161.294 | 199.191 | 1.235× | 163.617 | 198.261 | 1.212× |
| d768 in_proj | NT | 2048 × 768 × 3072 | `nt_sm120_tma_fma_m128n64_bk16_s2_kvec` | 164.336 | 203.116 | 1.236× | 166.354 | 202.567 | 1.218× |
| d768 in_proj | TN | 2048 × 768 × 3072 | `tn_sm120_tma_fma_m64n128_bk16_s2` | 140.880 | 144.064 | 1.023× | 141.300 | 142.362 | 1.008× |
| d768 out_proj | NN | 2048 × 1536 × 768 | `nn_sm120_tma_fma_m128n64_bk16_s2` | 91.912 | 96.641 | 1.051× | 93.723 | 95.644 | 1.021× |
| d768 out_proj | NT | 2048 × 1536 × 768 | `nt_sm120_tma_fma_m64n128_bk16_s2` | 85.181 | 113.716 | 1.335× | 86.353 | 112.786 | 1.306× |
| d768 out_proj | TN | 2048 × 1536 × 768 | `tn_sm120_tma_fma_m128n64_bk16_s2` | 76.194 | 81.866 | 1.074× | 76.552 | 80.588 | 1.053× |
| classifier page in_proj | NN | 4621 × 384 × 1928 | `nn_sm120_tma_fma_m64n128_bk16_s2` | 117.912 | 140.222 | 1.189× | 128.275 | 145.995 | 1.138× |
| classifier page in_proj | NT | 4621 × 384 × 1928 | `nt_sm120_tma_fma_m128n64_bk16_s2_kvec` | 116.163 | 152.607 | 1.314× | 115.806 | 154.084 | 1.331× |
| classifier page in_proj | TN | 4621 × 384 × 1928 | `tn_sm120_tma_fma_m128n64_bk16_s2` | 102.637 | 110.905 | 1.081× | 103.521 | 109.459 | 1.057× |
